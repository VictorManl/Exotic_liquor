if(screen.width < 1030){
	...
	document.write('<link rel="stylesheet" href="Responisve/1400/AcercaNosotros.css"></link>'); 
}
else if(screen.width < 1450){
	document.write('<link rel="stylesheet" href="Responisve/1440/AcercaNosotros.css"></link>');
}
else if(screen.width < 1610){
	document.write('<link rel="stylesheet" href="Responisve/1600/AcercaNosotros.css"></link>');
}
else if(screen.width < 1690){
	document.write('<link rel="stylesheet" href="Responisve/1680/AcercaNosotros.css"></link>');
}
